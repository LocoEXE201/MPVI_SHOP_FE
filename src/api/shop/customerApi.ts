...
const loadUserToken = () => {
  ...
  const createAddress = (data:object) => requestShop.post(`${ROOT_CUSTOMER}/CreateCustomer`, data,  {headers:{"Accept": "text/plain" ,"Content-Type": "application/json","Authorization": `Bearer ${loadUserToken()}`} ,withCredentials:true} );
