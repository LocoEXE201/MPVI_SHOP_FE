          ...
          <div className="w-[25rem] flex flex-col items-start justify-center pt-[0.937rem] px-[0rem] pb-[0rem] box-border">
            <div className="self-stretch flex flex-col items-start justify-start gap-[1.625rem]">
              <div className="self-stretch flex flex-col items-start justify-start gap-[0.312rem]">
                <div className="self-stretch rounded-8xs bg-whitesmoke-100 flex flex-row items-end justify-between pt-[0.562rem] px-[0.937rem] pb-[0.437rem] gap-[1.25rem] border-[1px] border-solid border-gray-600">
                ...
                <select className="self-stretch rounded-8xs bg-whitesmoke-100 flex flex-row items-end justify-between pt-[0.687rem] px-[0.937rem] pb-[0.375rem] font-baloo text-[1.125rem] text-gray-300 gap-[1.25rem] border-[1px] border-solid border-gray-600" />
                <select className="self-stretch rounded-8xs bg-whitesmoke-100 flex flex-row items-end justify-between pt-[0.687rem] px-[0.937rem] pb-[0.437rem] font-baloo text-[1.125rem] text-gray-300 gap-[1.25rem] border-[1px] border-solid border-gray-600" />
                <select className="self-stretch rounded-8xs bg-whitesmoke-100 flex flex-row items-end justify-between pt-[0.687rem] px-[0.937rem] pb-[0.437rem] font-baloo text-[1.125rem] text-gray-300 gap-[1.25rem] border-[1px] border-solid border-gray-600" />
                <select className="self-stretch rounded-8xs bg-whitesmoke-100 flex flex-row items-end justify-between pt-[0.812rem] px-[0.937rem] pb-[0.375rem] font-baloo text-[1.125rem] text-gray-300 gap-[1.25rem] border-[1px] border-solid border-gray-600" />
              </div>
              <div className="self-stretch rounded-xl flex flex-col items-start justify-start pt-[6.437rem] pb-[23.4rem] pr-[0.875rem] pl-[1.562rem] gap-[1.312rem] bg-[url('/image-11@2x.png')] bg-cover bg-no-repeat bg-[top] text-[3.125rem] text-white font-barlow-condensed mq900:pt-[4.188rem] mq900:pb-[15.188rem] mq900:box-border">
                <img
