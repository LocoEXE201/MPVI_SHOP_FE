...
const PageTitle: React.FC<PageTitleProps> = ({ mainTitle, subTitle }) => {
  return (
    <section className="bg-chocolate w-[117.563rem] mt-2 flex flex-row items-start justify-center py-[0rem] px-[1.25rem] box-border max-w-full text-left text-[1.25rem]">
